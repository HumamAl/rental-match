...
Previously built Rental PM Connect — a two-sided matching platform with separate owner/PM dashboards and vetting workflows.

Should the compliance acknowledgement be logged per-manager per-tenant, or once at account setup?

Quick call to align on scope, or I can draft the first milestone for review — your pick.
