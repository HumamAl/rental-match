...
const navItems = [
  { href: "/", label: "Match Overview", icon: LayoutDashboard },
  { href: "/rental-resumes", label: "Rental Resumes", icon: FileText },
  { href: "/search-tenants", label: "Search Tenants", icon: Search },
  { href: "/messages", label: "Messages", icon: MessageSquare },
  { href: "/disclosures", label: "Disclosures", icon: ShieldCheck },
];
